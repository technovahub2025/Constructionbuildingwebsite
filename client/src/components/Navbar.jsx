...
const Navbar = () => {
  ...
  // Lock body scroll + focus the close button when drawer opens
  useEffect(() => {
  ...
  return (
    <header className={`w-full sticky top-0 z-50 ${scrolled ? "shadow-[0_2px_10px_rgba(0,0,0,0.06)]" : ""}`}>
      {/* ========== TOP STRIP (Orange + diagonal notch + Navy) ========== */}
      <div className="relative w-full">
        <div className="relative flex h-10 sm:h-11">
          ...
          {/* White notch (triangle) */}
          <div
            aria-hidden="true"
            className="relative z-10 w-0 h-0 border-t-[20px] sm:border-t-[22px] border-b-[20px] sm:border-b-[22px] border-l-[16px] sm:border-l-[18px]
                       border-transparent border-l-white"
          />

          {/* Navy segment (fills remaining width) */}
          ...
          {/* Blue background shape (clip-path so it never overlaps content) */}
          <div
            aria-hidden="true"
      ...
      <div className="w-full bg-white border-b border-gray-200">
        <div className="max-w-7xl flex  mx-auto px-4">
          ...
          {/* Desktop menu */}
          <nav className="hidden  rounded-md  md:flex items-center justify-center gap-x-6 lg:gap-x-10 py-4 text-[15px] font-semibold ">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {/* Contact Info */}
          <div className="px-5 py-6 bg-gray-50 space-y-4 text-sm">
            <div className="flex items-start gap-3 text-gray-600">
              <svg className="w-5 h-5 text-[#ff6516] mt-0.5 shrink-0" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2C8.1 2 5 5.1 5 9c0 5.3 7 13 7 13s7-7.7 7-13c0-3.9-3.1-7-7-7zm0 9.5c-1.4 0-2.5-1.1-2.5-2.5S10.6 6.5 12 6.5s2.5 1.1 2.5 2.5S13.4 11.5 12 11.5z"/>
              </svg>
              <span>Jawahar Nagar, Reddiarpalayam, Puducherry</span>
            </div>
            
            <a href="mailto:simonraj88@gmail.com" className="flex items-center gap-3 text-gray-600 hover:text-[#ff6516] transition-colors">
              <svg className="w-5 h-5 text-[#ff6516] shrink-0" viewBox="0 0 24 24" fill="currentColor">
                <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
              </svg>
              <span>simonraj88@gmail.com</span>
            </a>
            
            <a href="tel:+919626424777" className="flex items-center gap-3 text-gray-600 hover:text-[#ff6516] transition-colors">
              <svg className="w-5 h-5 text-[#ff6516] shrink-0" viewBox="0 0 24 24" fill="currentColor">
                <path d="M6.6 10.8a15 15 0 0 0 6.6 6.6l2.2-2.2c.3-.3.8-.4 1.1-.2 1.1.5 2.3.8 3.6.8.6 0 1 .4 1 1V20c0 .6-.4 1-1 1C10.1 21 3 13.9 3 5c0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.7 3.6.1.3.1.6-.2 1.1l-2.2 2.2z"/>
              </svg>
              <span>+91 96264 24777 / +91 96884 24777</span>
            </a>
          </div>
          ...
          <div className="px-5 py-4 border-t">
            <div className="flex items-center justify-center gap-4">
              <a 
                href="#" 
                aria-label="Facebook"
                className="w-10 h-10 rounded-full bg-[#1877F2] text-white grid place-items-center hover:opacity-90 transition-opacity"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 1.576.077 1.786.112v3.340h-1.784c-1.116 0-1.419.534-1.419 1.657v2.449h3.188l-.53 3.667h-2.658v7.98H9.101z"/>
                </svg>
              ...
              <a 
                href="#" 
                aria-label="Twitter"
                className="w-10 h-10 rounded-full bg-[#1DA1F2] text-white grid place-items-center hover:opacity-90 transition-opacity"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.633 7.997c.013.175.013.349.013.523 0 5.325-4.053 11.461-11.46 11.461-2.282 0-4.402-.661-6.186-1.809.324.037.636.05.973.05a8.07 8.07 0 0 0 5.001-1.721 4.036 4.036 0 0 1-3.767-2.793c.249.037.499.062.761.062.361 0 .724-.05 1.061-.137a4.027 4.027 0 0 1-3.23-3.953v-.05c.537.299 1.16.486 1.82.511a4.022 4.022 0 0 1-1.796-3.354c0-.748.199-1.434.548-2.032a11.457 11.457 0 0 0 8.306 4.215c-.062-.3-.1-.611-.1-.923a4.026 4.026 0 0 1 4.028-4.028c1.16 0 2.207.486 2.943 1.272a7.957 7.957 0 0 0 2.556-.973 4.02 4.02 0 0 1-1.771 2.22 8.073 8.073 0 0 0 2.319-.624 8.645 8.645 0 0 1-2.019 2.083z"/>
                </svg>
              ...
              <a 
                href="#" 
                aria-label="YouTube"
                className="w-10 h-10 rounded-full bg-[#FF0000] text-white grid place-items-center hover:opacity-90 transition-opacity"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M21.593 7.203a2.506 2.506 0 0 0-1.762-1.766C18.265 5.007 12 5 12 5s-6.264-.007-7.831.404a2.56 2.56 0 0 0-1.766 1.778c-.413 1.566-.417 4.814-.417 4.814s-.004 3.264.406 4.814c.23.857.905 1.534 1.763 1.765 1.582.43 7.83.437 7.83.437s6.265.007 7.831-.403a2.515 2.515 0 0 0 1.767-1.763c.414-1.565.417-4.812.417-4.812s.02-3.265-.407-4.831zM9.996 15.005l.005-6 5.207 3.005-5.212 2.995z"/>
                </svg>
